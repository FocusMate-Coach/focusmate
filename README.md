...
| 기능 | 설명 |
|------|------|
| 스마트 타이머 | 과목·학습유형별 공부 시간 측정 |
| 집중도 체크인 | 세션 종료 후 1~5점 자가 평가 |
| 데이터 대시보드 | 시간대별·주간 학습 효율 시각화 |
...
### 3단계: 데이터 확인
1. **Analytics** 탭에서 학습 패턴을 시각적으로 확인합니다.
2. 시간대별 집중도, 주간 추이 등을 분석합니다.

### 4단계: AI 피드백 받기
1. **AI Coach** 탭으로 이동합니다.
2. **초개인화 AI 리포트 생성하기** 버튼을 클릭합니다.
...
가상 데이터 초기화: 대시보드 하단 **"학습 데이터 초기화"** 버튼 클릭
